...
const I18N_TEXT = {
    zh: {
        ...
        'message.highRiskConfirmFormData': '这会清除整个浏览器的自动填充数据。\n范围：{range}。\n扩展无法扫描或验证删除数量，请确认继续。',
        'message.highRiskConfirmPasswords': '这会清除整个浏览器保存的密码。\n范围：{range}。\n该操作无法由扩展验证删除数量，清除后可能需要重新登录，请确认继续。',
        'message.highRiskConfirmGuestMode': '这会清除当前站点数据、浏览记录与授权，并关闭该网页窗口，请确认继续。',
        'privacy.scopeNotice': '以下操作作用于整个浏览器，不受当前站点限制；扩展无法扫描此类数据数量，只能打开浏览器设置查看。',
        ...
        'message.formDataCleared': '自动填充数据清除请求已完成',
        'message.passwordsCleared': '保存密码清除请求已完成',
        'message.privacyClearRequestDone': '清除请求已完成，浏览器不返回删除数量',
        'message.privacyClearFailed': '清除失败',
        'message.privacyUnavailable': '当前浏览器不支持此操作',
        'message.privacyOpenSettingsFailed': '无法打开浏览器设置页，请手动访问',
        'guest.title': '无痕退出',
        'guest.desc': '清除当前站点数据、浏览记录与授权，然后关闭该网页',
        'guest.target': '目标：{domain}',
        'guest.targetUnavailable': '请在 http/https 网页中使用无痕退出',
        'guest.overrideWhitelist': '忽略白名单强制清理',
        'guest.btn': '无痕退出',
        'guest.timeRange.label': '浏览记录时间范围',
        'message.guestModeDone': '无痕退出完成，共执行 {count} 项清理',
        'message.guestModePartial': '无痕退出部分完成，失败项：{failures}',
        'message.guestModeFailed': '无痕退出执行失败',
        'message.guestModeBlockedByWhitelist': '当前站点受白名单保护，勾选“忽略白名单”可继续',
        'message.guestModeUnsupportedPage': '该页面不支持无痕退出'
    },
    en: {
        ...
        'cleanup.action.guestMode': 'private exit',
        ...
        'message.highRiskConfirmFormData': 'This will clear autofill data for the entire browser.\nRange: {range}.\nThe extension cannot scan or verify item counts. Continue?',
        'message.highRiskConfirmPasswords': 'This will clear saved passwords for the entire browser.\nRange: {range}.\nThe extension cannot verify item counts, and you may need to sign in again. Continue?',
        'message.highRiskConfirmGuestMode': 'This will clear current-site data, history and permissions, then close that webpage. Continue?',
        'privacy.scopeNotice': 'These actions affect the entire browser, not just the current site. The extension cannot scan item counts; use browser settings to review them.',
        ...
        'message.formDataCleared': 'Autofill clear request completed',
        'message.passwordsCleared': 'Saved-password clear request completed',
        'message.privacyClearRequestDone': 'Clear request completed; the browser does not return item counts',
        ...
        'guest.title': 'Private Exit',
        'guest.desc': 'Clear current-site data, history and permissions, then close the webpage',
        'guest.target': 'Target: {domain}',
        'guest.targetUnavailable': 'Open an http/https page to use Private Exit',
        'guest.overrideWhitelist': 'Ignore whitelist and force clean',
        'guest.btn': 'Private Exit',
        'guest.timeRange.label': 'History time range',
        'message.guestModeDone': 'Private exit done: {count} steps completed',
        'message.guestModePartial': 'Private exit partially done. Failed: {failures}',
        'message.guestModeFailed': 'Private exit failed',
        'message.guestModeBlockedByWhitelist': 'This site is whitelisted. Tick “Ignore whitelist” to proceed',
        'message.guestModeUnsupportedPage': 'This page type does not support Private Exit'
    }
};
